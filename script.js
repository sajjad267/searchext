  ...
  fetch("db2.json")
    ...
    .then((data) => {
      ...
      function createEmployeeCard(employee) {
        ...
        // Check if the field has a value before creating the element
        ...
        addPara("Designation", employee.designation);
        addPara("Department", employee.dept);
        addPara("Ext", employee.ext);
        addPara("Office", employee.office);
        addPara("Overseeing", employee.spResponse);
